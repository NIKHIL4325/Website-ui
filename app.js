...
let allProducts = [];
const isAuthReady = true; // Placeholder for future Firebase Authentication
...
const initializeApp = async () => {
    // 1. Fetch product data from the Vercel API
    await fetchProducts(); 
    
    // 2. Ensure cart count is updated immediately
    updateCartCount();
    
    // 3. Initialize page-specific logic based on the current URL
    ...
    // account.html is currently static
};
